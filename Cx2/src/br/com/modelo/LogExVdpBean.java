 ...
 * @author raul
 */
public class LogExVdpBean {

    private Integer lpcodigo;
    ...
    public int hashCode() {
        int hash = 7;
        hash = 97 * hash + Objects.hashCode(this.getLpcodigo());
    ...
    public boolean equals(Object obj) {
        ...
        final LogExVdpBean other = (LogExVdpBean) obj;
        if (!Objects.equals(this.lpcodigo, other.lpcodigo)) {
            return false;
        }
     ...
     * @return the lpcodigo
     */
    public Integer getLpcodigo() {
        return lpcodigo;
    }

    /**
     * @param lpcodigo the lpcodigo to set
     */
    public void setLpcodigo(Integer lpcodigo) {
        this.lpcodigo = lpcodigo;
    }
