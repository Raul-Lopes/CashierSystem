...
public class ItPrVpdvBean {
    ...
    private Double precosubpc;
    private Double precosubms;
    ...
    private Double qtdmedsolic;
    private Double qtdmedautor;
    ...
    public int hashCode() {
        int hash = 3;
        hash = 47 * hash + Objects.hashCode(this.getVdcodigo());
        hash = 47 * hash + Objects.hashCode(this.getNumitem());
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ItPrVpdvBean other = (ItPrVpdvBean) obj;
    ...
    /**
     * @return the precosubpc
     */
    public Double getPrecosubpc() {
        return precosubpc;
    }

    /**
     * @param precosubpc the precosubpc to set
     */
    public void setPrecosubpc(Double precosubpc) {
        this.precosubpc = precosubpc;
    }

    /**
     * @return the precosubms
     */
    public Double getPrecosubms() {
        return precosubms;
    }

    /**
     * @param precosubms the precosubms to set
     */
    public void setPrecosubms(Double precosubms) {
        this.precosubms = precosubms;
    }
    ...
    /**
     * @return the qtdmedsolic
     */
    public Double getQtdmedsolic() {
        return qtdmedsolic;
    }

    /**
     * @param qtdmedsolic the qtdmedsolic to set
     */
    public void setQtdmedsolic(Double qtdmedsolic) {
        this.qtdmedsolic = qtdmedsolic;
    }

    /**
     * @return the qtdmedautor
     */
    public Double getQtdmedautor() {
        return qtdmedautor;
    }

    /**
     * @param qtdmedautor the qtdmedautor to set
     */
    public void setQtdmedautor(Double qtdmedautor) {
        this.qtdmedautor = qtdmedautor;
    }
