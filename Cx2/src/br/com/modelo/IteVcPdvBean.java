...
public class IteVcPdvBean {
    ...
    public int hashCode() {
        ...
        hash = 67 * hash + Objects.hashCode(this.getVdcodigo());
        hash = 67 * hash + Objects.hashCode(this.getNumitem());
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final IteVcPdvBean other = (IteVcPdvBean) obj;
