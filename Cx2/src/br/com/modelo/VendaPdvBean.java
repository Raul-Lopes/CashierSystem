...
public class VendaPdvBean {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 41 * hash + Objects.hashCode(this.getCacodigo());
        hash = 41 * hash + Objects.hashCode(this.getVdcodigo());
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final VendaPdvBean other = (VendaPdvBean) obj;
    ...
    /**
     * @return the flagfinan
     */
    public String getFlagfinan() {
        return flagfinan;
    }

    /**
     * @param flagfinan the flagfinan to set
     */
    public void setFlagfinan(String flagfinan) {
        this.flagfinan = flagfinan;
    }
